...
public class WndRanking extends WndTabbed {
	...
	private class TalentsTab extends Group{
		...
		public TalentsTab(){
			...
			if (Dungeon.hero.lvl >= 12 && (Dungeon.hero.subClass != HeroSubClass.NONE || Dungeon.hero.heroClass2 != null)) tiers++;
			if (Dungeon.hero.lvl >= 20 && (Dungeon.hero.armorAbility != null || Dungeon.hero.subClass2 != HeroSubClass.NONE)) tiers++;
