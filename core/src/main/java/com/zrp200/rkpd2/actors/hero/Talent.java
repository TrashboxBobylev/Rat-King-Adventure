...
public enum Talent {
	...
	//Highness T3
	PARTY_FEELING(imageAt(8, 12), 3), SLASH_RUNNER(imageAt(9, 12), 3), PROLONGED_JOY(imageAt(10, 12), 3),
	//Challenge T4
	...
	public static void initSubclassTalents( HeroSubClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents, int tier){
		...
		switch (cls){
			...
			case MONK:
				...
				break;
			case HIGHNESS:
				Collections.addAll(tierTalents, PARTY_FEELING, SLASH_RUNNER, PROLONGED_JOY);
				break;
